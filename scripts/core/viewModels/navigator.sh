...
#└───────────────────────────────────────────────────┘
    ...
    # Сохраняем тип перехода (переход не из pages)
        NAVIGATOR_PAGES=''
...
#┌────────────────────────────────────────────────────────────┐
#│ Переходит в новый раздел из pages (без сохранения истории) │
#└────────────────────────────────────────────────────────────┘
    'pages')
    # Сохраняем тип перехода (переход из pages)
        NAVIGATOR_PAGES=1
        
    # Переходим в новый раздел
        core:Navigator 'section' "${@:2}"
    ;;
...
#└────────────────────────────┘
    'current')
        core:Navigator 'section' "$NAVIGATOR_CURRENT" "${@:2}"
    ;;
