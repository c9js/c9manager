...
#└──────────────────┘
    ...
    'build:c9php')    "$PATH_WORKSPACE/scripts/c9start/entrypoint.sh" 'build' "${1/*:}" ;;
...
#└────────────────┘
    ...
    'tag1:c9php')     docker tag "${1/*:}" "$DOCKER_USER/${1/*:}:$NEW_VERSION" ;;
    ...
    'tag2:c9php')     docker tag "${1/*:}" "$DOCKER_USER/${1/*:}:latest"       ;;
...
#└───────────────────────────────────────┘
    ...
    'push1:c9php')    docker push "$DOCKER_USER/${1/*:}:$NEW_VERSION" ;;
    ...
    'push2:c9php')    docker push "$DOCKER_USER/${1/*:}:latest"       ;;
esac
}
