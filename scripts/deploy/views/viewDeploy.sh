#▄────────────────────────────────────────▄
#█                                        █
#█  Список команд перед началом continue  █
#█                                        █
#▀────────────────────────────────────────▀
CONTINUE_LIST=(
...
# Создание тегов
    'tag1:c9open'    # Создает теги для новой версии
    'tag1:c9start'   # Создает теги для новой версии
    'tag1:c9docker'  # Создает теги для новой версии
    'tag2:c9open'    # Создает теги для последней версии
    'tag2:c9start'   # Создает теги для последней версии
    'tag2:c9docker'  # Создает теги для последней версии
...
#└─────────────────────┘
    'header') case "$SELECTION" in
        ...
        0) printf "Пробуем продолжить деплой (версия '%s')"          "$NEW_VERSION" ;;
    esac
    ;;
