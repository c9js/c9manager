...
# Создание образов
    ...
    'build:c9php'    # Создает новый образ
...
# Создание тегов
    ...
    'tag1:c9php'     # Создает тег для новой версии
    ...
    'tag2:c9php'     # Создает тег для последней версии
...
# Загрузка в репозиторий
    ...
    'push1:c9php'    # Загружает новую версию в docker-репозиторий
    ...
    'push2:c9php'    # Загружает последнюю версию в docker-репозиторий
)
...
#└─────────────────────────────────────┘
    ...
    # Создание образов
        ...
        'build:c9php')    printf "Создаем образ '${2/*:}'"                             ;;
    ...
    # Создание тегов
        ...
        'tag1:c9php')     printf "Создаем тег '$DOCKER_USER/${2/*:}:$NEW_VERSION'"     ;;
        ...
        'tag2:c9php')     printf "Создаем тег '$DOCKER_USER/${2/*:}:latest'"           ;;
    ...
    # Загрузка в репозиторий
        ...
        'push1:c9php')    printf "Загружаем образ '$DOCKER_USER/${2/*:}:$NEW_VERSION'" ;;
        ...
        'push2:c9php')    printf "Загружаем образ '$DOCKER_USER/${2/*:}:latest'"       ;;
    esac
    ;;
...
#└─────────────────────────────┘
    ...
    # Создание образов
        ...
        'build:c9php')    error "Образ '${2/*:}' не был создан!"             ;;
    ...
    # Создание тегов
        ...
        'tag1:c9php')     error "Тег '$DOCKER_USER/${2/*:}:$NEW_VERSION' не был создан!"     ;;
        ...
        'tag2:c9php')     error "Тег '$DOCKER_USER/${2/*:}:latest' не был создан!"           ;;
    ...
    # Загрузка в репозиторий
        ...
        'push1:c9php')    error "Образ '$DOCKER_USER/${2/*:}:$NEW_VERSION' не был загружен!" ;;
        ...
        'push2:c9php')    error "Образ '$DOCKER_USER/${2/*:}:latest' не был загружен!"       ;;
    esac
    ;;
