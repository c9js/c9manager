...
# Runners
. $PATH_DIR/runners/runnerManager.sh
. $PATH_DIR/runners/runnerProject.sh
...
. $PATH_DIR/views/viewManager.sh
. $PATH_DIR/views/viewProject.sh
...
PATH_PROJECTS_SORT="$PATH_WORKSPACE/.c9/projects_sort"    # Список отсортированных проектов
...
PROJECTS_MAX=5              # Количество проектов на странице
IMAGES_MAX=5                # Количество образов на странице

#┌──────────────────────────────────────────────────────────┐
#│ Список образов которые можно запустить (запуск проектов) │
#└──────────────────────────────────────────────────────────┘
IMAGES_MANAGER=(
    'c9js/c9open'         # Базовый образ
    'c9js/c9vue'          # Образ для Vue.js
)
...
# Графические интерфейсы
    1) case "$1" in
        'manager') entrypoint:Manager "$@" ;; # Запуск проектов
